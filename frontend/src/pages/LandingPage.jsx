        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ background:"rgba(74,222,128,0.06)",
              ...
              <div style={{ display:"flex", gap:"10px", marginBottom:"6px", fontSize:"13px", color:"#b8a09a" }}>
                <span style={{ color:"#60a5fa", fontWeight:"700", flexShrink:0 }}>1.</span>
                Open Safari and visit{" "}
                <a href="https://app.projogroup.co.za" target="_blank" rel="noreferrer"
                  style={{ color:"#60a5fa", fontWeight:"700" }}>app.projogroup.co.za</a>
              </div>
              {["Tap the 3-dot menu at top right","Tap: Add to Home screen","Tap: Add to confirm"].map((s,i) => (
