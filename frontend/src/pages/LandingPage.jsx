        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ background:"rgba(74,222,128,0.06)",
              ...
              {["Open Chrome and visit app.projogroup.co.za","Tap the 3-dot menu at top right","Tap: Add to Home screen","Tap: Add to confirm"].map((s,i) => (
            ...
            <div style={{ background:"rgba(96,165,250,0.06)",
              ...
              {["Open Safari and visit app.projogroup.co.za",
