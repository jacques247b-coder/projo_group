    ...
    <div style={{ background: BG, minHeight: "100vh", color: "#f0ede8", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", padding: "88px 1rem 2rem" }}>
        <div style={{ textAlign: "center", padding: "4rem 2rem" }}>
          ...
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: "24px", fontWeight: "800", color: G, marginBottom: "8px" }}>Finance</div>
          <div style={{ fontSize: "14px", color: "#6b6760", marginBottom: "2rem", lineHeight: 1.6 }}>Personal budget and expenses</div>
